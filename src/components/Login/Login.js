    ...
    return (
            <div className="logindiv mt-5">
                    ...
                    <form style={{display:user.existingUser ? 'none': 'block'}} onSubmit={createAccount}>
                        ...
                        <input type="text" onBlur={handleChange} name="email" placeholder="Your Email" required/>
                        <br/>
                        <input type="password" onBlur={handleChange} name="password" placeholder="Your Password (8 Characters)" required/>
                        <br/>
                    ...
                    <br></br>
                    {
                        user.isSignedIn ? <button className="submitbtn" onClick={handleSignOut} >Sign out</button> :
                        <button className="submitbtn" onClick={handleSignIn} >Sign in with Google</button>
                    }
        </div>
    );
};
